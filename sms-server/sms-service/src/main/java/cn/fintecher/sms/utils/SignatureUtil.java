...
public class SignatureUtil {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException{
		String signStr = "{\"accountId\":\"admin\",\"timestamp\":\"2017-06-01 10:50:11\",\"sign\":\"bf94268326ecebe2f710679ee371a25262795dc8\"}";
		JSONObject json = JSONObject.parseObject(signStr);
		String timestamp = json.getString("timestamp");
		String accountId = json.getString("accountId");
		String shaSignStrc = getSHA1(echostr, timestamp, accountId);
		System.out.println(shaSignStrc);
		System.out.println(signStr);
		boolean shaSignStr = chkSignature(signStr);
		System.out.println(shaSignStr);
		//chkSignature(signStr);
	}
