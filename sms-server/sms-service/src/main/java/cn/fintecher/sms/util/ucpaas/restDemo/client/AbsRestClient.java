...
import cn.fintecher.sms.util.ucpaas.restDemo.SSLHttpClient;
...
public abstract class AbsRestClient {
	 ...
	 * voiceCode
	 */
	public abstract String voiceCode(String accountSid, String authToken,String appId,String to,String verifyCode,String displayNum, String playTimes);
	/**
	 * 
	 * @param accountSid
	 * @param authToken
